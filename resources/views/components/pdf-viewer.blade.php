...
@php
    $nutrientService = app(\App\Services\NutrientService::class);
...
>
    ...
    <div
        ...
        style="height: {{ $height }}; display: flex; align-items: center; justify-content: center; background: #f9fafb;"
    >
    ...
    <div
        ...
        style="height: {{ $height }}; display: flex; align-items: center; justify-content: center; background: #fef2f2;"
    >
    ...
    Alpine.data('pdfViewer', (config) => ({
        ...
        async loadViewer() {
            ...
            if (this.documentId && !docUrl) {
                docUrl = `/api/pdf/documents/${this.documentId}/file`;
            }
        ...
        setupAnnotationHandlers() {
            ...
            // Listen for successful save completion (Nutrient SDK event)

...
class CabinetMathAuditService
{
    ...
    public function generateFullAudit(Cabinet|array $input): array
    {
        ...
        // Generate 3D positions for all parts
        $positions3d = $this->generate3dPositions($specs, $gate1, $gate4, $gate5, $gate6);
    ...
    protected function normalizeInput(Cabinet|array $input): array
    {
        ...
        return array_merge([
            ...
            'face_frame_rail' => 1.5,
            'face_frame_thickness' => self::HARDWOOD_5_4,  // 5/4 hardwood = 1" actual
    ...
    public function auditGate1_CabinetBox(array $specs): array
    {
        ...
        $calculations = [
            ...
            [
                'name' => 'Inside Depth',
                'formula' => 'Cabinet Depth - Back Thickness',
                'values' => "{$cabinetDepth}\" - {$backPanelThickness}\"",
                'result' => $insideDepth,
    ...
    public function generate3dPositions(array $specs, array $gate1, array $gate4, array $gate5, array $gate6): array
    {
        ...
        $parts['bottom'] = [
            'part_name' => 'Bottom',
            'part_type' => 'cabinet_box',
            'position' => ['x' => $sideThickness, 'y' => $boxH - $sideThickness, 'z' => 0],

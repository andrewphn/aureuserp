...
class OpeningConfiguratorService
{
    ...
    public function collectAllComponents(CabinetSection $section): Collection
    {
        ...
        foreach ($section->falseFronts as $falseFront) {
            $components->push([
                'model' => $falseFront,
                'type' => 'false_front',
                'height' => $falseFront->height_inches ?? 0,
                'width' => $falseFront->width_inches ?? $section->opening_width_inches ?? 0,
    ...
    public function getComponentConsumedHeight(Model $component, string $type): float
    {
        return match ($type) {
            ...
            'false_front' => $component->height_inches ?? 0,
            default => 0,
        };
    }

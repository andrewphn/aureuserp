...
class DrawerController extends BaseResourceController
{
    protected string $modelClass = Drawer::class;

    protected array $searchableFields = ['drawer_code', 'notes'];
    ...
    {
        return [
            'drawer_code' => 'sometimes|string|max:50',
            'drawer_type' => 'nullable|string|max:50',
            'position_from_top' => 'nullable|integer|min:0',
            'height_inches' => 'nullable|numeric|min:0',
            'depth_inches' => 'nullable|numeric|min:0',

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Check if description column exists in projects_tags table
        $hasDescriptionColumn = Schema::hasColumn('projects_tags', 'description');

        // If description column doesn't exist, remove it from the arrays

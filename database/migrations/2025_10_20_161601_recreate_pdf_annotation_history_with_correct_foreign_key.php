...
return new class extends Migration
{
     ...
     * Run the migrations.
     *
     * Recreates pdf_annotation_history table with correct foreign key.
     * NOW points to pdf_page_annotations (the correct, detailed system).
     */
    public function up(): void
    {
        ...
        Schema::create('pdf_annotation_history', function (Blueprint $table) {
            ...
            // Reference to the annotation - NOW POINTS TO CORRECT TABLE
            $table->foreignId('annotation_id')
                ->nullable()
                ->constrained('pdf_page_annotations')  // ✅ CORRECT: Points to detailed system
                ->onDelete('cascade');

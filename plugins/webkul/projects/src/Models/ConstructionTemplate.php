...
class ConstructionTemplate extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            // Face Frame Style Settings
            'default_face_frame_style' => 'string',
            'frameless_reveal_gap' => 'float',
            'frameless_bottom_reveal' => 'float',
            'face_frame_reveal_gap' => 'float',
            'face_frame_bottom_reveal' => 'float',
            'full_overlay_amount' => 'float',
            'full_overlay_reveal_gap' => 'float',
            'full_overlay_bottom_reveal' => 'float',
            'inset_reveal_gap' => 'float',
            'inset_bottom_reveal' => 'float',
            'partial_overlay_amount' => 'float',
            'partial_overlay_reveal_gap' => 'float',
            'partial_overlay_bottom_reveal' => 'float',
            'drawer_cavity_clearance' => 'float',
            'end_panel_install_overage' => 'float',
            // Material Thickness

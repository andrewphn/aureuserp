...
class Dashboard extends BaseDashboard
{
    ...
    {
        return __('webkul-project::filament/pages/dashboard.navigation.title');
    }

    public static function getNavigationGroup(): string
    {
        return __('webkul-project::filament/pages/dashboard.navigation.group');
    }
                        ...
                        Section::make()
                            ...
                            ->schema([
                                Select::make('selectedProjects')
                                    ->label(__('webkul-project::filament/pages/dashboard.filters-form.project'))
                                    ->multiple()
                                    ->searchable()
                                    ->preload()
                                ...
                                Select::make('selectedAssignees')
                                    ->label(__('webkul-project::filament/pages/dashboard.filters-form.assignees'))
                                    ->multiple()
                                    ->searchable()
                                    ->preload()
                                ...
                                Select::make('selectedTags')
                                    ->label(__('webkul-project::filament/pages/dashboard.filters-form.tags'))
                                    ->multiple()
                                    ->searchable()
                                    ->preload()
                                ...
                                Select::make('selectedPartners')
                                    ->label(__('webkul-project::filament/pages/dashboard.filters-form.customer'))
                                    ->multiple()
                                    ->searchable()
                                    ->preload()
                                ...
                                DatePicker::make('startDate')
                                    ->label(__('webkul-project::filament/pages/dashboard.filters-form.start-date'))
                                    ->maxDate(fn (Get $get) => $get('endDate') ?: now())
                                    ->default(now()->subMonth()->format('Y-m-d'))
                                    ->native(false),
                                DatePicker::make('endDate')
                                    ->label(__('webkul-project::filament/pages/dashboard.filters-form.end-date'))

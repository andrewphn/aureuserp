...
class ManageTasks extends SettingsPage
{
    ...
    {
        return [
            __('webkul-project::filament/clusters/settings/pages/manage-tasks.title'),
        ];
    }

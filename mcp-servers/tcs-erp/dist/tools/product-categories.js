 ...
 */
export const productCategoryTools = [
    {
...
export async function handleProductCategoryTool(client, toolName, args) {
    switch (toolName) {
        ...
        case 'get_product_category':
            return client.getProductCategory(args.id);
        case 'create_product_category':
            return client.createProductCategory(args);
        case 'update_product_category': {
            const { id, ...data } = args;
            return client.updateProductCategory(id, data);
        }
        case 'delete_product_category':
            return client.deleteProductCategory(args.id);
        default:

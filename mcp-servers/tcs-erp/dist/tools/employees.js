...
export async function handleEmployeeTool(client, toolName, args) {
    switch (toolName) {
        case 'list_employees':
            return client.listEmployees(args);
        case 'get_employee':
            return client.getEmployee(args.id);
        case 'create_employee':
            return client.createEmployee(args);
        case 'update_employee': {
            const { id, ...data } = args;
            return client.updateEmployee(id, data);
        }
        case 'delete_employee':
            return client.deleteEmployee(args.id);
        default:
